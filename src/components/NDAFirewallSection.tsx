...
const NDAFirewallSection = ({
  ...
  const authorizedUsers: AuthorizedUser[] = [
    ...
    { id: "exec-r-and-d", name: "Research & Development", email: "rd@mercedes-benz.com" },
    { id: "exec-design", name: "Design Studio", email: "design@mercedes-benz.com" },
    { id: "exec-amg", name: "Mercedes-AMG", email: "amg@mercedes-benz.com" },
    { id: "exec-strategy", name: "Corporate Strategy", email: "strategy@mercedes-benz.com" },
    { id: "exec-board", name: "Executive Board", email: "board@mercedes-benz.com" },
    { id: "exec-audit", name: "Internal Audit", email: "audit@mercedes-benz.com" },
    { id: "exec-sales", name: "Global Sales", email: "sales@mercedes-benz.com" },
    { id: "exec-marketing", name: "Global Marketing", email: "marketing@mercedes-benz.com" },
  ];
      ...
      <div className="container mx-auto max-w-[1400px] px-16 md:px-24 lg:px-32 h-full">
        ...
        <div className="max-w-4xl mx-auto flex flex-col justify-center h-full py-8">
          ...
          <UnifiedSectionHeader
            ...
            subtitle="Sensitive strategic information accessible to authorized Mercedes-Benz executives and board members."
            animate={true}
          />
          ...
          <div className="glass-strong rounded-2xl p-8 md:p-12 border border-white/10 shadow-elegant">
            ...
            <div className="flex justify-center items-center gap-4 mb-10">
              ...
              <div className="text-center">
                <h4 className="text-white/90 text-lg font-semibold">Mercedes-Benz Executive Board</h4>
