                    ...
                    <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-6">
                        ...
                        {showConfirmButton ? (
                            <button
                                ...
                                className="w-full py-4 px-6 bg-[#ff6600] hover:bg-[#ff6600]/90 text-white font-bold rounded-lg transition-all flex items-center justify-center gap-2 shadow-lg shadow-[#ff6600]/30 animate-pulse hover:animate-none"
                            >
